...
namespace WordShuffle
{
    class Program
    {
        ...
        static string ReverseArrayToString(string[] inputArray)
        {
        ...
        static void Main(string[] args)
        {
            ...
            string reverseString; // перевернутая строка
            ...
            reverseString = ReverseArrayToString(SplitStringIntoWords(sentence));
